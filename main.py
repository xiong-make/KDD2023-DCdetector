...
def main(config):
    # 根据输入数据的大小在运行时选择最适合的卷积算法，从而提高计算性能
...
if __name__ == '__main__':
    ...
    parser.add_argument('--patch_size', type=list, default=[3, 5, 7])
    ...
    parser.add_argument('--data_path', type=str, default='SMD')
    ...
    sys.stdout = Logger("result/" + config.data_path + ".log", stream=sys.stdout)
    if config.mode == 'train':
        print("\n\n")
